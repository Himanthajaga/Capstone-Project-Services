  ...
  apps : [
    {
        ...
        script : "./cloud-sql-proxy capstone-project-490416:asia-southeast1:postgres-vm capstone-project-490416:asia-southeast1:mysql-vm --private-ip",
    ...
    },
    {
      ...
      instances: 2,
      env: {
        GOOGLE_APPLICATION_CREDENTIALS: "/opt/keys/student-service-key.json"
      }
    }
  ],
}
